...
class WebServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            # Objective 3 -- Add new restaurant to DB part 1
            ...
            # Objective 4 part 1 edit restaurant name
            if self.path.endswith("/edit"):
                ...
                if myRestaurantQuery != []:
                    ...
                    output += "<input name= 'submit' value='Rename'>"
                    output += "</form>"
    ...
    def do_POST(self):
        try:
            # Objective 3 -- Add new restaurant to DB part 2
            if self.path.endswith("/restaurants/new"):
